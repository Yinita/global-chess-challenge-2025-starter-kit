...
Your prompt template should be a Jinja2 template file (`.jinja`) that may use the following variables:
...
The move must be in UCI format and must be one of the legal moves from `legal_moves_uci` or `legal_moves_uci_list`.
